...
module Icons =
    ...
    let chevronsUp : IBrush -> Control = line "M 4 9.6 L 8 5.6 L 12 9.6 M 4 4.4 L 8 0.4 L 12 4.4"
    let chevronsDown : IBrush -> Control = line "M 4 6.4 L 8 10.4 L 12 6.4 M 4 11.6 L 8 15.6 L 12 11.6"
